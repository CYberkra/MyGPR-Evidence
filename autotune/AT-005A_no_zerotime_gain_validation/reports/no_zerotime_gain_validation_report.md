...
## Metadata
- Source commit: `d54d54e8dff16f0f791744ede4e8be4c2c1b4531`
...
| `field_raw_input` | `field_visual` | `none` | -- | 0.001001 | `valid_with_caveats` | `figures/field_raw_input.png` |
| `field_background_only` | `field_visual` | `none` | -- | 0.001001 | `valid_with_caveats` | `figures/field_background_only.png` |
| `field_background_energy_decay_gain` | `field_visual` | `energy_decay_gain` | -- | 0.001001 | `valid_with_caveats` | `figures/field_background_energy_decay_gain.png` |
| `field_background_time_power_gain` | `field_visual` | `time_power_gain_local` | -- | 0.001001 | `valid_with_caveats` | `figures/field_background_time_power_gain.png` |
| `field_background_agc_gain` | `field_visual` | `agcGain` | -- | 0.001001 | `valid_with_caveats` | `figures/field_background_agc_gain.png` |
